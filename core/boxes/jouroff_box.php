 ...
 */
class jouroffbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "jouroff@jouroff";
    public $boxlabel;
    public $depends = array("jouroff");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/jouroff/class/jouroff.class.php";
